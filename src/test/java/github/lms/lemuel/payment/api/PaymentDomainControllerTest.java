...
import github.lms.lemuel.payment.adapter.in.api.PaymentController;
...
class PaymentDomainControllerTest {
    ...
    void shouldCreatePaymentSuccessfully() throws Exception {
        ...
        given(createPaymentPort.createPayment(any(CreatePaymentCommand.class))).willReturn(paymentDomain);
    ...
    void shouldAuthorizePaymentSuccessfully() throws Exception {
        ...
        given(authorizePaymentPort.authorizePayment(paymentId)).willReturn(paymentDomain);
    ...
    void shouldCapturePaymentSuccessfully() throws Exception {
        ...
        given(capturePaymentPort.capturePayment(paymentId)).willReturn(paymentDomain);
    ...
    void shouldRefundPaymentSuccessfully() throws Exception {
        ...
        given(refundPaymentPort.refundPayment(paymentId)).willReturn(paymentDomain);
    ...
    void shouldGetPaymentSuccessfully() throws Exception {
        ...
        given(getPaymentPort.getPayment(paymentId)).willReturn(paymentDomain);
